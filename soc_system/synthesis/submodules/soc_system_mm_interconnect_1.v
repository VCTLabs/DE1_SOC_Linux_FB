...
module soc_system_mm_interconnect_1 (
		...
		input  wire        pll_stream_outclk0_clk,                                              //                                            pll_stream_outclk0.clk
	...
	wire  [127:0] alt_vip_vfr_vga_avalon_slave_agent_rf_source_data;                        // alt_vip_vfr_vga_avalon_slave_agent:rf_source_data -> alt_vip_vfr_vga_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [127:0] alt_vip_vfr_vga_avalon_slave_agent_rsp_fifo_out_data;                     // alt_vip_vfr_vga_avalon_slave_agent_rsp_fifo:out_data -> alt_vip_vfr_vga_avalon_slave_agent:rf_sink_data
	...
	wire  [126:0] alt_vip_vfr_vga_avalon_slave_agent_rp_data;                               // alt_vip_vfr_vga_avalon_slave_agent:rp_data -> router_004:sink_data
	...
	wire          cmd_mux_001_src_valid;                                                    // cmd_mux_001:src_valid -> alt_vip_vfr_vga_avalon_slave_burst_adapter:sink0_valid
	wire  [126:0] cmd_mux_001_src_data;                                                     // cmd_mux_001:src_data -> alt_vip_vfr_vga_avalon_slave_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                    // alt_vip_vfr_vga_avalon_slave_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [6:0] cmd_mux_001_src_channel;                                                  // cmd_mux_001:src_channel -> alt_vip_vfr_vga_avalon_slave_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                            // cmd_mux_001:src_startofpacket -> alt_vip_vfr_vga_avalon_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                              // cmd_mux_001:src_endofpacket -> alt_vip_vfr_vga_avalon_slave_burst_adapter:sink0_endofpacket
	...
	wire  [126:0] alt_vip_vfr_vga_avalon_slave_burst_adapter_source0_data;                  // alt_vip_vfr_vga_avalon_slave_burst_adapter:source0_data -> alt_vip_vfr_vga_avalon_slave_agent:cp_data
	...
	wire    [6:0] alt_vip_vfr_vga_avalon_slave_burst_adapter_source0_channel;               // alt_vip_vfr_vga_avalon_slave_burst_adapter:source0_channel -> alt_vip_vfr_vga_avalon_slave_agent:cp_channel
	...
	wire  [126:0] cmd_demux_002_src2_data;                                                  // cmd_demux_002:src2_data -> cmd_mux_002:sink2_data
	...
	wire  [126:0] cmd_demux_002_src3_data;                                                  // cmd_demux_002:src3_data -> cmd_mux_003:sink2_data
	...
	wire  [126:0] cmd_demux_002_src4_data;                                                  // cmd_demux_002:src4_data -> cmd_mux_004:sink2_data
	...
	wire  [126:0] cmd_demux_002_src5_data;                                                  // cmd_demux_002:src5_data -> cmd_mux_005:sink2_data
	...
	wire  [126:0] cmd_demux_002_src6_data;                                                  // cmd_demux_002:src6_data -> cmd_mux_006:sink0_data
	...
	wire  [126:0] rsp_demux_002_src2_data;                                                  // rsp_demux_002:src2_data -> rsp_mux_002:sink2_data
	...
	wire  [126:0] rsp_demux_003_src2_data;                                                  // rsp_demux_003:src2_data -> rsp_mux_002:sink3_data
	...
	wire  [126:0] rsp_demux_004_src2_data;                                                  // rsp_demux_004:src2_data -> rsp_mux_002:sink4_data
	...
	wire  [126:0] rsp_demux_005_src2_data;                                                  // rsp_demux_005:src2_data -> rsp_mux_002:sink5_data
	...
	wire  [126:0] rsp_demux_006_src0_data;                                                  // rsp_demux_006:src0_data -> rsp_mux_002:sink6_data
	...
	wire  [126:0] cmd_demux_002_src1_data;                                                  // cmd_demux_002:src1_data -> crosser_002:in_data
	wire          cmd_demux_002_src1_ready;                                                 // crosser_002:in_ready -> cmd_demux_002:src1_ready
	wire    [6:0] cmd_demux_002_src1_channel;                                               // cmd_demux_002:src1_channel -> crosser_002:in_channel
	...
	wire  [126:0] crosser_002_out_data;                                                     // crosser_002:out_data -> cmd_mux_001:sink2_data
	wire          crosser_002_out_ready;                                                    // cmd_mux_001:sink2_ready -> crosser_002:out_ready
	wire    [6:0] crosser_002_out_channel;                                                  // crosser_002:out_channel -> cmd_mux_001:sink2_channel
	...
	wire  [126:0] rsp_demux_001_src0_data;                                                  // rsp_demux_001:src0_data -> crosser_003:in_data
	...
	wire  [126:0] crosser_003_out_data;                                                     // crosser_003:out_data -> rsp_mux:sink1_data
	...
	wire  [126:0] rsp_demux_001_src1_data;                                                  // rsp_demux_001:src1_data -> crosser_004:in_data
	wire          rsp_demux_001_src1_ready;                                                 // crosser_004:in_ready -> rsp_demux_001:src1_ready
	wire    [6:0] rsp_demux_001_src1_channel;                                               // rsp_demux_001:src1_channel -> crosser_004:in_channel
	...
	wire  [126:0] crosser_004_out_data;                                                     // crosser_004:out_data -> rsp_mux_001:sink1_data
	wire          crosser_004_out_ready;                                                    // rsp_mux_001:sink1_ready -> crosser_004:out_ready
	wire    [6:0] crosser_004_out_channel;                                                  // crosser_004:out_channel -> rsp_mux_001:sink1_channel
	...
	wire  [126:0] rsp_demux_001_src2_data;                                                  // rsp_demux_001:src2_data -> crosser_005:in_data
	wire          rsp_demux_001_src2_ready;                                                 // crosser_005:in_ready -> rsp_demux_001:src2_ready
	wire    [6:0] rsp_demux_001_src2_channel;                                               // rsp_demux_001:src2_channel -> crosser_005:in_channel
	...
	wire  [126:0] crosser_005_out_data;                                                     // crosser_005:out_data -> rsp_mux_002:sink1_data
	wire          crosser_005_out_ready;                                                    // rsp_mux_002:sink1_ready -> crosser_005:out_ready
	wire    [6:0] crosser_005_out_channel;                                                  // crosser_005:out_channel -> rsp_mux_002:sink1_channel
	...
	wire          alt_vip_vfr_vga_avalon_slave_agent_rdata_fifo_out_valid;                  // alt_vip_vfr_vga_avalon_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] alt_vip_vfr_vga_avalon_slave_agent_rdata_fifo_out_data;                   // alt_vip_vfr_vga_avalon_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          alt_vip_vfr_vga_avalon_slave_agent_rdata_fifo_out_ready;                  // avalon_st_adapter_001:in_0_ready -> alt_vip_vfr_vga_avalon_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                                        // avalon_st_adapter_001:out_0_valid -> alt_vip_vfr_vga_avalon_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                         // avalon_st_adapter_001:out_0_data -> alt_vip_vfr_vga_avalon_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                        // alt_vip_vfr_vga_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                        // avalon_st_adapter_001:out_0_error -> alt_vip_vfr_vga_avalon_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_burst_adapter #(
		...
		.clk                   (pll_stream_outclk0_clk),                                           //       cr0.clk
	...
	soc_system_mm_interconnect_1_cmd_mux_006 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_rsp_demux_006 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_clk           (pll_stream_outclk0_clk),                                              //       out_clk.clk
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_clk            (pll_stream_outclk0_clk),                                              //        in_clk.clk
	...
	soc_system_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pll_stream_outclk0_clk),                                        // in_clk_0.clk
